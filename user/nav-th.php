...
function generateLanguageMenu()
{
    return '<div class="lang-menu">
                <div class="selected-lang">
                    <button class="change-lang">TH</button>
                </div>
                <ul>
                    <li>
...
<nav class="navbar">
    ...
    <div class="menu">
        <div class="menu-links-left">
            <a href="./HomeTH.php">หน้าหลัก</a>
            <a href="./MoviesTH.php">ภาพยนตร์</a>
            <a href="./CinemasTH.php">โรงภาพยนตร์</a>
        </div>
        <?php if (isLoggedIn()): ?>
            <div class="user-info">
        ...
        <?php else: ?>
            ...
            <a href="./includes/login.php" class="btn-login">เข้าสู่ระบบ</a>
        <?php endif; ?>
    </div>
</nav>
